...
public class Signup_Librarian extends JFrame implements ActionListener{
    ...
    public static void main(String[] args) {
        new Signup_Librarian().setVisible(true);
    }

    public Signup_Librarian() {
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(128, 128, 0), 2), "Librarian-Account",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                String sql = "insert into librarian_account(username, name, password, sec_q, sec_ans) values(?, ?, ?, ?, ?)";
