...
public class IssueBook extends JFrame implements ActionListener{
   ...
   // JDateChooser dateChooser;
    ...
    private JTextField t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t16,t17,t18;
	...
	JLabel l17 = new JLabel("DOR");
	l17.setForeground(new Color(47, 79, 79));
	l17.setFont(new Font("Tahoma", Font.BOLD, 14));
	l17.setBounds(47, 340, 100, 23);
	contentPane.add(l17);
	...
	t17.setForeground(new Color(47, 79, 79));
	t17.setFont(new Font("Trebuchet MS", Font.BOLD, 14));
	t17.setColumns(10);
	t17.setBounds(126, 340, 208, 20);
    ...
    public void actionPerformed(ActionEvent ae){
		...
		rs.close();
            ...
            if(ae.getSource() == b3){
                    try{
                String sql = "insert into issueBook(book_id, student_id, bname, sname, course, branch, dateOfIssue,dateOfReturn) values(?, ?, ?, ?, ?, ?, ?,?)";
		PreparedStatement st = con.c.prepareStatement(sql);
		st.setString(1, t1.getText());
		...
		st.setString(7, t18.getText());
		st.setString(8, t17.getText());
		String test = t18.getText();
