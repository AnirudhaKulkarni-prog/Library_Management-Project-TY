...
public class Introduction_Home extends JFrame implements ActionListener{

	private JPanel contentPane;
        private JButton b1,b2,b3,b4,b5,b6;

	public static void main(String[] args) {
            new Introduction_Home().setVisible(true);
	}
        
        public Introduction_Home() {
            ...
            JMenu mnExit = new JMenu("Account");
            mnExit.setFont(new Font("Trebuchet MS", Font.BOLD, 17));
            
            
            JMenuItem mntmLogout = new JMenuItem("Student Login");
            mntmLogout.setBackground(new Color(211, 211, 211));
            mntmLogout.setForeground(new Color(105, 105, 105));
            mntmLogout.addActionListener(this);
            mnExit.add(mntmLogout);
            
            JMenuItem mntmLibrarian_Login = new JMenuItem("Librarian Login");
            mntmLibrarian_Login.setBackground(new Color(211, 211, 211));
            mntmLibrarian_Login.setForeground(new Color(105, 105, 105));
            mntmLibrarian_Login.addActionListener(this);
            mnExit.add(mntmLibrarian_Login);
          ...
          //  menuBar.add(mnRecord);
            ...
            JLabel l1 = new JLabel("Welcome To Library Management System");
            l1.setForeground(new Color(204, 51, 102));
            l1.setFont(new Font("Segoe UI Semilight", Font.BOLD, 30));
            l1.setBounds(200, 200, 900, 350);
            contentPane.add(l1);
           ...
           /* JLabel l2 = new JLabel("");
            ...
            ImageIcon i4  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/stat.jpeg"));
            Image i5 = i4.getImage().getScaledInstance(200, 200,Image.SCALE_DEFAULT);
            ImageIcon i6 = new ImageIcon(i5);
            l3 = new JLabel(i6);
            l3.setBounds(274, 160, 134, 128);
            contentPane.add(l3);

            JLabel l4 = new JLabel("");
            ImageIcon i7  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/Addstudent1.png"));
            Image i8 = i7.getImage().getScaledInstance(150, 150,Image.SCALE_DEFAULT);
            ImageIcon i9 = new ImageIcon(i8);
            l4 = new JLabel(i9);
            l4.setBounds(490, 140, 225, 152);
            contentPane.add(l4);
            
            JLabel l5 = new JLabel("");
            ImageIcon i10  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/Addstudent1.png"));
            Image i11 = i10.getImage().getScaledInstance(150, 150,Image.SCALE_DEFAULT);
            ImageIcon i12 = new ImageIcon(i8);
            l5 = new JLabel(i12);
            l5.setBounds(710, 140, 225, 152);
            contentPane.add(l5);
		...
		new Login_user().setVisible(true);
            }else if(msg.equals("Librarian Login")){
            	setVisible(false);
