...
public class Librarian extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Librarian() {
            ...
            ImageIcon i10  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/deletestudent.png"));
            Image i11 = i10.getImage().getScaledInstance(150, 150,Image.SCALE_DEFAULT);
            ImageIcon i12 = new ImageIcon(i11);
            l5 = new JLabel(i12);
            l5.setBounds(529,460, 225, 152);
            contentPane.add(l5);
            
            JLabel l6 = new JLabel("");
            ImageIcon i13  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/updatestudent.png"));
            Image i14 = i13.getImage().getScaledInstance(150, 150,Image.SCALE_DEFAULT);
            ImageIcon i15 = new ImageIcon(i14);
            l5 = new JLabel(i15);
            l5.setBounds(252,460, 225, 152);
            contentPane.add(l5);
            ...
            b4.setBounds(550,640,167,44);
            contentPane.add(b4);
            
            b5 = new JButton("Update Student");
            b5.addActionListener(this);
            b5.setBackground(Color.darkGray);
            b5.setForeground(Color.WHITE);
            b5.setBounds(270,640,167,44);
            contentPane.add(b5);
            

           JPanel panel = new JPanel();
            panel.setBorder(new TitledBorder(new LineBorder(new Color(250, 128, 114), 2), "Librarian-Operation", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(220, 20, 60)));
            panel.setBounds(50, 120, 900, 600);
